...
export const Image = ({ id, alt = "Jacobs Img", mobilesrcfile, tabletsrcfile, desktopsrcfile, height, width }) => {
  ...
  return (
    <PictureWrapper>
      ...
      <Img id={id} alt={alt} src={desktopsrcfile} height={height} width={width} />
    </PictureWrapper>
  );
};
